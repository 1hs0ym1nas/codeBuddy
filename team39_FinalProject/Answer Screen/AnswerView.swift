...
//        markCompletedButton.backgroundColor = UIColor.green
//        markCompletedButton.setTitleColor(.white, for: .normal)
//        markCompletedButton.layer.cornerRadius = 8
//
//        // Add Subviews
...
//
//            // Countdown Label
//            countdownLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 15),
//            countdownLabel.centerXAnchor.constraint(equalTo: contentView.centerXAnchor),
//
//            // Text View
//            textView.topAnchor.constraint(equalTo: countdownLabel.bottomAnchor, constant: 20),
